...
class incremental_NCM_classifier(nn.Module):
    ...
    def forward(self,x):
        ...
        # print('means reshaped shape:', means_reshaped.shape)
        ...
        # print('ncm diff shape:', diff.shape)
        # print('ncm diff:', diff[0])
        # print('ncm diff:', diff[100])
    ...
    # Add a class to the dataset, updating the labels indices
